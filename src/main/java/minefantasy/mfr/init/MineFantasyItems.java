...
//	public static Item[] INGOTS;
	...
	public static void initFood() {
		...
		BERRIES = new ItemFoodMFR("berries", 0, 0.0F, false).setEatTime(10).setStaminaRestore(10F).setAlwaysEdible();
		BERRIES_JUICY = new ItemFoodMFR("berries_juicy", 0, 0.0F, false).setEatTime(10).setStaminaRestore(25F).setRarity(1).setAlwaysEdible();
